...
필터로 상장사 전체를 거르고, ★추천 점수(업종 +3 · KSIC 완전일치 +3/앞4 +2/앞3 +1 · 키워드 제품 +2/업종 +1 ·
제품 토큰유사 +1(≤3) · 시총유사 +2 · 제외어 −5 · 신규상장 −5) 순으로 정렬한다. **[정밀 추천(상위 20)]**은
상위 후보만 DART 주요계정·감사의견을 받아 재점수한다(매출유사 +2 · 흑자 +1/적자 −1 · 비적정 제외 · D/E>5x −3).
**표에서 찾기**에 회사가 준 피어 리스트를 통째로 붙여넣으면 매칭 행 하이라이트,
